...
for(Z in seq(1,11,1)){
  png(paste0("../Results/RidgePlots/SlopeError_null",Z,".png"), width = 5900, height = 3000, res = 150)
  X = levels(Comb$FunctionReName)[Z]
  Title = ifelse(X == "Random",paste(" Slopes (no trend) \n", "Missing: Completely at random", sep = ""), paste("Slopes (no trend) \n", "Missing: ", X, sep = ""))
