...
Plot = ggarrange(NoBias, WeakBias, SevereBias, ncol= 3, common.legend = TRUE, legend="bottom", widths = c(1.2,1,4))
ggsave("../Results/SummaryPlots/RegressionErrorPositiveVsMissingVsBiasRefined.pdf" ,plot = last_plot(), width = 70, height = 30, units = "cm")
