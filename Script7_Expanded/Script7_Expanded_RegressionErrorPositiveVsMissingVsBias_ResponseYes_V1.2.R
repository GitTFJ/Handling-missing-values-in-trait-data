...
NoBias = ggplot() + 
  geom_ribbon(data = Ribbon[which((Ribbon$FunctionReName == "Random")& Ribbon$ResponsePresent == "Yes"),],
              aes(ymin = Min, ymax = Max, x = Missing, fill = ImputationApproach, linetype = ImputationApproach), alpha = 0.3) +
  geom_line(data = Ribbon[which((Ribbon$FunctionReName == "Random")& Ribbon$ResponsePresent == "Yes"),],
...
ControlledBias = ggplot() + 
  geom_ribbon(data = Ribbon[which((Ribbon$FunctionReName == "Trait" | Ribbon$FunctionReName == "Phylogeny")& Ribbon$ResponsePresent == "Yes"),],
              aes(ymin = Min, ymax = Max, x = Missing, fill = ImputationApproach, linetype = ImputationApproach), alpha = 0.3) +
  geom_line(data = Ribbon[which((Ribbon$FunctionReName == "Trait" | Ribbon$FunctionReName == "Phylogeny")& Ribbon$ResponsePresent == "Yes"),],
            aes(y = (pred), x = Missing, linetype = ImputationApproach, colour = ImputationApproach), size = 1) +
  facet_grid(.~FunctionReName, scale="free", space = "free_y") +
  scale_fill_manual(values = c("black", "red2", "blue", "blue", "blue", "cyan3")) +
  scale_colour_manual(values = c("black","black","black","black","black","black")) +
...
WeakBias = ggplot() + 
  geom_ribbon(data = Ribbon[which((Ribbon$FunctionReName == "Trait " | Ribbon$FunctionReName == "Phylogeny " | Ribbon$FunctionReName == "Response" | Ribbon$FunctionReName == "Trait*Response")& Ribbon$ResponsePresent == "Yes"),],
              aes(ymin = Min, ymax = Max, x = Missing, fill = ImputationApproach, linetype = ImputationApproach), alpha = 0.3) +
  geom_line(data = Ribbon[which((Ribbon$FunctionReName == "Trait " | Ribbon$FunctionReName == "Phylogeny " | Ribbon$FunctionReName == "Response" | Ribbon$FunctionReName == "Trait*Response")& Ribbon$ResponsePresent == "Yes"),],
            aes(y = (pred), x = Missing, linetype = ImputationApproach, colour = ImputationApproach), size = 1) +
  facet_grid(.~FunctionReName, scale="free", space = "free_y") +
  scale_fill_manual(values = c("black", "red2", "blue", "blue", "blue", "cyan3")) +
  scale_colour_manual(values = c("black","black","black","black","black","black")) +
...
ggsave("../Results/SummaryPlots/RegressionErrorPositiveVsMissingVsBias_ResponseYes.png" ,plot = Plot, width = 90, height = 45, units = "cm")
